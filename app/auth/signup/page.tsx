...
const Signup = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<EventTarget>) => {
        ...
        try {
            ...
            toast.error("Error creating account!");  // Show error toast if there's an exception
        }
    };
    ...
    return (
        <>
            <section className="bg-gray-50 dark:bg-gray-900">
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto min-h-[77.9vh] lg:py-0">
